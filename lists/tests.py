...
class ListViewTest(TestCase):
    ...
    def test_displays_all_list_items(self):
        ...
        # Assert: Check if the created values are in the home page
        self.assertContains(response, 'itemey 1')  # Django specific test that knows how to find content inside
